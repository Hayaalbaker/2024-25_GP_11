...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              ListTile(
                leading: Icon(Icons.rate_review, color: const Color(0xFF800020)), // Set color
              ...
              ListTile(
                leading: Icon(Icons.add_location_alt, color: const Color(0xFF800020)), // Set color
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _pages = [
      ...
      ProfileScreen(), // Navigate to Profile Page
    ];
    ...
    return Scaffold(
      ...
      floatingActionButton: GestureDetector(
        ...
        child: FloatingActionButton(
          ...
          child: Icon(Icons.add, color: Colors.white), // Floating plus icon with white color
        ),
      ),
      floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked, // Center the button above the nav bar
    );
  }
}
