...
class FirestoreService {
  ...
  Future<void> addUserDetails(String userName, String country, String city, List<String> interests) async {
    try {
  ...
  // Add review
  Future<void> addReview(String reviewId, String placeId, String reviewText, DateTime reviewDate, int like, int dislike) async {
    try {
      User? user = _auth.currentUser;
      if (user != null) {
